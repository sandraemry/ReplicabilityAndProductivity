...
* JEMBE also has *MethodsX* articles that can be submitted alongside the primary publication, to detail the exact protocol and methods used in the research design. A [Word and LaTex template](https://www.elsevier.com/__data/assets/word_doc/0020/203528/MethodsX-Article-Template.docx) is also provided for this cosubmission. 
